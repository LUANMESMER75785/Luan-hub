# Luan-hubif game.PlaceId == 2753915549 then
    World1 = true
...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 2600 or MyLevel <= 549 then
            Mon = "Royal Squad"
            LevelQuest = 1
...
OrionLib:MakeNotification({
    ...
    Image = https://www.bing.com/search?q=imagem+de+cria&qs=n&form=QBRE&sp=-1&lq=0&pq=imagem+de+cria&sc=15-14&sk=&cvid=97EDC062FB004FC6B48D16C2764CF2BA&ghsh=0&ghacc=0&ghpl=
    Time = 5
})
